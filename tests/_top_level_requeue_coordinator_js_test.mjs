...
const projectLog=await projectLifecycle(plan,"actual-run","project-prompt-123"); assert.deepEqual(projectLog,[["list","actual-run"],["claim","actual-run",exact.handoff_id],["submit"],["queued","actual-run",exact.handoff_id,"queued","project-prompt-123"],["track","actual-run",exact.handoff_id,"project-prompt-123"]]);
