...
class Node {
    ...
    addDOMWidget(name,type,root,options) { this.root=root; assert.equal(options.serialize,false); return {}; }
...
const second=new Node(2);second.properties.h3_selflift_batch=batch.id;second.onNodeCreated();await settle();
...
console.log("SelfLift hunt UI: persistent takes, stable playback, uint64 seeds, approval, shared/hidden polling and cleanup pass");
