...
| [`feature/review-gate-prompt-resize`](https://github.com/Psylenceo/ComfyUI-MiniMaxH3-Context-Loop/tree/feature/review-gate-prompt-resize) | Adds a dedicated drag-to-resize grip to the Review Gate's scene prompt editor, matching the video preview panel's resize interaction (pointer-capture drag, zoom-aware scaling, double-click to reset), shown only when Review Gate prompt editing is enabled. | [PR #50](https://github.com/ethanfel/ComfyUI-MiniMaxH3-Context-Loop/pull/50) open |
